    ...
    return (
        <div className="bg-black text-white py-16">
            <div className="max-w-7xl mx-auto px-6">
                <h1 className="text-4xl text-center md:text-left mb-12">Contact Info</h1>
                    ...
                    {icons.map((icon, index) => (
                        ...
                        >
                            <div className="flex items-center justify-center w-12 h-12 border border-white rounded-full hover:bg-white transition-colors duration-300">
                                <icon.picture className="text-white text-2xl group-hover:text-blue-500 transition-colors duration-300" />
                            </div>
                        </a>
                    ))}
                </div>
